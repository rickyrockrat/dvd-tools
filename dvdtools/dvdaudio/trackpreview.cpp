...
trackPreviewWnd::trackPreviewWnd( QWidget *w, const char *name, WFlags f )
													: QLabel( w, name, f )
{
	m_track = 0;
	m_norm = PAL;
...
trackPreviewWnd::trackPreviewWnd( QListViewItem *t,
...
void trackPreviewWnd::setTrack( QListViewItem *t )
{
	m_track = t;
}
...
QListViewItem *trackPreviewWnd::track()
{
	return m_track;
}
